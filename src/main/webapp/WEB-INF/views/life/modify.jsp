	...
	<div class="container" id="body">
		<div class="row" id="inner">
			<div class="col">
				...
				<form id="modifyForm" method="post" enctype="multipart/form-data">
					...
					<div class="form-group1 게시물-테두리-패딩">
						...
						<select class="form-control " id="input3" name="tag">
							...
							<option value="영화&드라마" <c:if test="${board.tag  eq '영화&드라마'}">selected</c:if>>영화&드라마</option>
				...
				<a href="${pageContext.request.contextPath }/life/list/${board.id }" class="btn btn-outline-secondary">취소</a>
			</div>
		</div>
	</div>

				...
				<div id="buttonmenu" class="row md mx-4 d-flex justify-content-between">
					<div class="col-md-2 my-auto px-auto ">
						<c:if test="${sessionScope.loginUser.id eq post.memberId }">
							<a href="${pageContext.request.contextPath }/life/modify?id=${post.id }"	class="btn btn-outline-secondary"> 수정/삭제 </a>
						</c:if>
					</div>
					<div class="col-md-2 my-auto px-auto">
						<a href="${pageContext.request.contextPath }/life/list?location="	class="btn btn-outline-secondary"><i class="fas fa-list"> 뒤로</i></a>
					</div>
				</div>
